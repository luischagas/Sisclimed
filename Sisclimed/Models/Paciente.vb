...
Public Class paciente
    ...
    Public Sub New(nome As String, dataNasc As Date, endereco As String, numero As String, complemento As String, bairro As String, estado As String, cidade As String, convenio As Integer, estadoCivil As String, sexo As String, email As String, cpf As String, profissao As String, telefone As String, celular As String, cep As String, password As String, tipo As String)
        Me.nome = nome
    ...
    Public Sub New(nome As String, dataNasc As Date, endereco As String, numero As String, complemento As String, bairro As String, estado As String, cidade As String, convenio As Integer, estadoCivil As String, sexo As String, email As String, cpf As String, profissao As String, telefone As String, celular As String, cep As String, password As String, pacienteId As Integer, tipo As String)
        Me.nome = nome
        Me.dataNasc = dataNasc
        Me.endereco = endereco
        Me.numero = numero
        ...
        Try
            ...
            For Each ps In protocoloSplit
                ...
                If info.Count = 3 Then
                    Me.Add(New paciente(info(0), info(1), info(2), info(3), info(4), info(5), info(6), info(7), info(8), info(9), info(10), info(11), info(12), info(13), info(14), info(15), info(16), info(17), info(18)))
                End If
            Next
        Catch ex As Exception
        End Try
