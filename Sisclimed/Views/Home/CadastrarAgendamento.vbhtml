        ...
        <div class="row">
                        ...
                        <table id="tblAgendamento" class="lista-agendamento table table-condensed table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Médico</th>
                                    <th id="lblExcluirAgendamento">Excluir?</th>
                                </tr>
                            </thead>
                            <tbody id="tbodyAgendamentos" class="tbodyAgendamentos" data-bind="foreach: agendamentoKO.agendamentoList">
                                <tr data-bind="attr: { id: 'trAgendamento' + agendamentoId, 'data-Id': agendamentoId }, event: { dblclick: showModalUPT, doubletap: showModalUPT }">
                                    ...
                                    <td><div  data-bind="attr: { id: 'trAgendamento' + agendamentoId, 'data-Id': agendamentoId }, event: { click: DeleteAgendamento }" class="img-icone"></div></td>
            ...
            <div class="row">
                <div class="col-md-12" style="margin:0; text-align:right;">
                    <button id="btnCadastrarNovoAgendamento" type="button" class="shortcut primary buttonInside" style="display:none" required>
                    ...
                    <div class="modal-content">
                        ...
                        <form name="form" data-toggle="validator">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label>Nome:</label>
                                                    <input id="txtNomeAgendamento" type="text" class="form-control input-sm" data-bind="textInput:agendamentoKO.nomePaciente, event: {keypress: enterSearch}" tabindex="1" required>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <select id="txtEspecialidadeAgendamento" class="slcEspecialidade form-control input-sm" tabindex="3" data-bind="textInput: agendamentoKO.especialidade, event: {keypress: enterSearch}"></select>
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label>Médico:</label>
                                                    <select id="txtMedicoAgendamento" class="slcMedico form-control input-sm" tabindex="4" data-bind="textInput: agendamentoKO.medicoId, event: {keypress: enterSearch}"></select>
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label>Data:</label>
                                                    <select id="txtDataAgendamento" class="slcData form-control input-sm" data-bind="options: agendamentoKO.data, optionsText: 'DataHoraValue', selectedOptions: agendamentoKO.dataHora, value: agendamentoKO.dataHora, optionsCaption: 'Selecione', event: {keypress: enterSearch}" tabindex="5">
                                                     
                                                    </select>
                                                </div>
                                                @*<div class="form-group col-md-3">
                                                    <label>Hora:</label>
                                                    <select id="txtHoraAgendamento" class="slcHora form-control input-sm" data-bind="textInput: agendamentoKO.hora, event: {keypress: enterSearch}" tabindex="6">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea rows="4" cols="40" maxlength="300" class="form-control input-sm" id="txtObsAgendamento" data-bind="textInput: agendamentoKO.obs, event: {keypress: enterSearch}" tabindex="7"></textarea>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="modal-footer">
                                <button id="btnSalvarNovoAgendamento" type="button" class="shortcut primary buttonFooter" tabindex="8" data-bind="enable: agendamentoKO.validCadastro" style="display:none" required>
                                    <i class="icon-floppy" style="margin-right:5px;"></i>
                                    <span>Salvar</span>
                                </button>
                                <button id="btnLimparAgendamento" type="button" class="shortcut primary buttonFooter" style="display:none" required>
