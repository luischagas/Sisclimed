                ...
                <div class="modal-content">
                    ...
                    <form name="form" data-toggle="validator">
                        ...
                        <div class="modal-footer">
                            <button id="btnSalvarNovoHistorico" type="button" class="shortcut primary buttonFooter" tabindex="5" style="display:none;" required>
                                <i class="icon-floppy" style="margin-right:5px;"></i>
                                <span>Salvar</span>
                            </button>
                            <button id="btnLimparHistorico" type="button" class="shortcut primary buttonFooter" style="display:none;" required>
